...
- `lib/supabase/20241121_fhir_ggz_schema.sql` - Database schema implementatie
...
- **Database Schema** — `lib/supabase/20241121_fhir_ggz_schema.sql`
...
**Schema File:** `lib/supabase/20241121_fhir_ggz_schema.sql`
